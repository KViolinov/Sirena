...
<html lang="en">
	<head>
	    ...
	    <title>Sirena - Регистрация</title>
...
strong{
        ...
        <!-- end header -->
         <!--header image -->
          ...
          <div class="header-img">
            ...
            <div class="top">
                <span>Регистрация в системата</span>
                
                <header>Регистрация</header>
                
         <!--       <strong> Временно недостъпна :)</strong>  -->
 ...
 <form method ="post" class="templatemo-login-form">
	        	...
	        	<div class="input-field">
		              	<input id="text" type="text" class="input"  name="user_name" placeholder="Потребителско име" required>
					...
					<div class="input-field">
		              	...
		              	<input id="text" type="password" class="input" name="password" placeholder="Парола" required>
            ...
            <p class="text">Вече имате регистрация? <a href="login.php">Вход</a></p>
