    ...
    <body class="templatemo-container">
        ...
        <div class="container my-5">
            ...
            <form method = "post">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3" col-form-label>Име на клъстера</label>
                    <div class = "col-sm-6">
                        <input type = "text" class = "form-control" name = "cluster_name" value = "<?php echo $cluster_name; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3" col-form-label>Описание на клъстера</label>
                    <div class = "col-sm-6">
                ...
                <div class="row mb-3">
                    <label class="col-sm-3" col-form-label>Критична ниво за известяване (в см.)</label>
                    <div class = "col-sm-6">
                        <input type = "text" class = "form-control" name = "cluster_critical_level" value = "<?php echo $cluster_critical_level; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3" col-form-label>Електронна поща за известяване</label>
                    <div class = "col-sm-6">
                        <input type = "text" class = "form-control" name = "cluster_email_notation" value = "<?php echo $cluster_email; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-3" col-form-label>Телефон за известяване</label>
                    <div class = "col-sm-6">
                ...
                <div class = "row mb-3">
                    ...
                    <div class = "col-sm-3 d-grid">
                        <a class = "btn btn-outline-primary" href = "index.php" role = "button">Отказ</a>
                    </div>
                </div>
            </form>
        </div>
